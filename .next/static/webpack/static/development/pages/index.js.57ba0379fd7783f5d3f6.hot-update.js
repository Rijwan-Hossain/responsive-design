...
function Info() {
  return __jsx("div", {
    ...
    __self: this
  }, "& I am "), __jsx(react_typed__WEBPACK_IMPORTED_MODULE_4___default.a // typedRef={typedRef()}
  , {
    loop: true,
    typeSpeed: 80,
    backSpeed: 60,
    strings: [" Computer Programmer", " Team Player", " JavaScript Developer", " React-Redux Developer", " NodeJS Developer", " Problem Solver"],
    smartBackspace: true // shuffle={false}
    ,
    backDelay: 500 // fadeOut={false}
    ,
    fadeOutDelay: 1000,
    loopCount: 0,
    showCursor: true,
...
//# sourceMappingURL=index.js.57ba0379fd7783f5d3f6.hot-update.js.map